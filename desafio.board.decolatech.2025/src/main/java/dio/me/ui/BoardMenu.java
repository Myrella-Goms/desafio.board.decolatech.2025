...
import dio.me.services.BoardColumnsQueryService;
import dio.me.services.BoardQueryService;
import dio.me.services.CardQueryService;
import dio.me.services.CardService;
...
public class BoardMenu {
    ...
    private void showColumn() throws SQLException {
        ...
        try(var connection = getConnection()){
            var column = new BoardColumnsQueryService(connection).findById(selectedColumnId);
            column.ifPresent(co -> {
